...
//        return getHeight();
    ...
    public void setCvCameraViewListener(CvCameraViewListener2 listener) {
        mListener = listener;
        Log.d("OpenCV", "setCvCameraViewListener: " + (listener == null));
    }
    ...
    private void onEnterStartedState() {
        ...
        /* Connect camera */
        if (!connectCamera(getCaptureWidth(), getCaptureHeight())) {
     ...
     */
    // ====== custom implementation for displaying portrait =======
        ...
        if (bmpValid && mCacheBitmap != null) {
            ...
            if (canvas != null) {
                ...
                if (scaleMat == null) {
                    ...
                    float imgw = mCacheBitmap.getWidth();
                    float imgh = mCacheBitmap.getHeight();
                    float scale = Math.min(vw / imgw, vh / imgh);
                    scaleMat = new Matrix();
                    scaleMat.preScale(scale, scale, vw / 2, vh / 2);
                }
                canvas.setMatrix(scaleMat);
     ...
     * @param frame - the current frame to be delivered
     */
    // OpenCV Original implementation.
    protected void deliverAndDrawFrameO(CvCameraViewFrame frame) {
        Mat modified;
